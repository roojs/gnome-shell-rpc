/**
 * Clutter Stage Helper for C ABI gaps (libshell link).
 *
 * Wire prefix ''Clutter-Stage''. Live GObject returns use uint64 lease
 * in {@link OLLMrpc.Response.args} (not retval).
