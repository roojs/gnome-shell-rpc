...
export const LayoutManager = GObject.registerClass({
    ...
    _loadBackground() {
        ...
        let signalId = this._systemBackground.connect('loaded', () => {
            ...
            console.log('GSR-A4 SystemBackground loaded signal received');
            ...
            const id = GLib.idle_add(GLib.PRIORITY_LOW, () => {
                console.log(`GSR-A4 Startup Animation idle primaryMonitor=${!!this.primaryMonitor}`);
                if (this.primaryMonitor) {
                    this._systemBackground.show();
                    global.stage.show();
                    console.log('GSR-A4 calling _prepareStartupAnimation');
    ...
    async _prepareStartupAnimation() {
        console.log("GSR-A4 _prepareStartupAnimation enter");
